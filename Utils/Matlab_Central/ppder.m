...
% 
%   Source: https://www.mathworks.com/matlabcentral/fileexchange/46580-periodical-cubic-interpolation
% 
if ~isstruct(p)
    dp=polyder(p);
else
    ...
    % 2021.05.18. (május 18, kedd), 10:44 (JAVITVA: a dimenzioval)
    dp=mkpp(p.breaks,dpp,p.dim);
end